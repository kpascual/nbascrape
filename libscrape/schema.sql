...
) ENGINE=MyISAM AUTO_INCREMENT=41116 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=732381 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shotchart_cbssports` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_game_id` (`game_id`)
) ENGINE=MyISAM AUTO_INCREMENT=343408 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shotchart_nbacom` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_game_id` (`game_id`)
) ENGINE=MyISAM AUTO_INCREMENT=271278 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shotchart_espn` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_game_id` (`game_id`)
) ENGINE=MyISAM AUTO_INCREMENT=271075 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `playshot`
--

DROP TABLE IF EXISTS `playshot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playshot` (
  `playbyplay_espn_id` int(11) NOT NULL,
  `game_id` int(11) DEFAULT NULL,
  `period` int(11) DEFAULT NULL,
  `play_num` int(11) DEFAULT NULL,
  `deciseconds_left` int(11) DEFAULT NULL,
  ...
  `foul_info` varchar(50) DEFAULT NULL,
  `shot_type` varchar(50) DEFAULT NULL,
  `distance_playbyplay_espn` int(11) DEFAULT NULL,
  `away_fiveman` varchar(30) DEFAULT NULL,
  `home_fiveman` varchar(30) DEFAULT NULL,
  `play_desc` varchar(500) DEFAULT NULL,
  `shotchart_cbssports_id` int(11) DEFAULT NULL,
  `shotchart_espn_id` int(11) DEFAULT NULL,
  `shotchart_nbacom_id` int(11) DEFAULT NULL,
  `shot_num_shotchart` int(11) DEFAULT NULL,
  `shotchart_cbssports_x` mediumint(9) DEFAULT NULL,
  `shotchart_cbssports_y` mediumint(9) DEFAULT NULL,
  `shotchart_espn_x` mediumint(9) DEFAULT NULL,
  `shotchart_espn_y` mediumint(9) DEFAULT NULL,
  `shotchart_nbacom_x` mediumint(9) DEFAULT NULL,
  `shotchart_nbacom_y` mediumint(9) DEFAULT NULL,
  `shot_type_nbacom_id` int(11) DEFAULT NULL,
  `shot_type_cbssports_id` mediumint(9) DEFAULT NULL,
  `distance_shotchart_cbssports` int(11) DEFAULT NULL,
  `is_shot` tinyint(4) DEFAULT NULL,
  `is_shot_made` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`playbyplay_espn_id`),
  KEY `idx_player_id` (`player_id`),
  KEY `idx_player1_id` (`player1_id`),
  KEY `idx_assist_player_id` (`assist_player_id`),
  KEY `idx_play_id` (`play_espn_id`),
  KEY `idx_game_id` (`game_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `playshot_espn`
--

DROP TABLE IF EXISTS `playshot_espn`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playshot_espn` (
  `playbyplay_espn_id` int(11) NOT NULL,
  `game_id` int(11) DEFAULT NULL,
  `period` int(11) DEFAULT NULL,
  `play_num` int(11) DEFAULT NULL,
...
--
-- Table structure for table `playshot_nbacom`
--

DROP TABLE IF EXISTS `playshot_nbacom`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playshot_nbacom` (
  `playbyplay_espn_id` int(11) NOT NULL,
  `game_id` int(11) DEFAULT NULL,
  `period` int(11) DEFAULT NULL,
  `play_num` int(11) DEFAULT NULL,
...
--
-- Table structure for table `playshot_cbssports`
--

DROP TABLE IF EXISTS `playshot_cbssports`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playshot_cbssports` (
  `playbyplay_espn_id` int(11) NOT NULL,
  `game_id` int(11) DEFAULT NULL,
  `period` int(11) DEFAULT NULL,
  `play_num` int(11) DEFAULT NULL,
...
-- Dump completed on 2012-02-12 17:06:35
